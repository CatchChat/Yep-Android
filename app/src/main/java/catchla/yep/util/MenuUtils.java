...
public class MenuUtils {
    ...
    public static void setMenuGroupAvailability(final Menu menu, final int groupId, final boolean available) {
        if (menu == null) return;
        menu.setGroupEnabled(groupId, available);
        menu.setGroupVisible(groupId, available);
    }
